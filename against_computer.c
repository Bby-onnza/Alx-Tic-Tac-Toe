 ...
 * 
 * singleplayer - driver function for the single player mode
 * computerMove - controls how the computer plays
 * playerMove - set of instructions for the player's input
 * resetBoard - function to reset the board after each round
 * printBoard - draws and prints the board
 * checkFreeSpaces - checks for  free spaces on the board
